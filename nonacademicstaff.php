...
<body class="bg-gray-100">
        ...
        <ul class="navbar-nav ml-auto flex items-center">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="active dropdown-item" href="academicstaff.php">Academic Staff</a></li>
  ...
  <h2 class="text-2xl font-bold mb-2 text-center">Non-Academic staffs</h2>

  <section class="container mx-auto mt-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
    ...
    $academicQuery = "SELECT * FROM staff WHERE category = 'non-academic'";
    $academicResult = mysqli_query($connection, $academicQuery);

    while ($academicRow = mysqli_fetch_assoc($academicResult)) {
      ?>
      <div class="card">
        <img src="./dashboard/<?php echo $academicRow['staff_image']; ?>" alt="<?php echo $academicRow['staff_name']; ?>"
          class="staff-image">
        <div class="card-body">
          <h5 class="card-title">
            <?php echo $academicRow['staff_name']; ?>
          </h5>
          <p class="card-text">
            <?php echo $academicRow['qualifications']; ?>
          </p>
          <p class="card-text">
            <?php echo $academicRow['email']; ?>
          </p>
        </div>
      </div>
      <?php
